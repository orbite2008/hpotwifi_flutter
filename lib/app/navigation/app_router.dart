...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/auth/register-email', name: 'registerEmail', builder: (_, __) => const RegisterEmailPage()),
      GoRoute(path: '/auth/register-details', name: 'registerDetails', builder: (_, __) => const RegisterDetailsPage()),
      GoRoute(path: '/auth/register-password', name: 'registerPassword', builder: (_, __) => const RegisterPasswordPage()),
      GoRoute(path: '/auth/reset-password', name: 'resetPassword', builder: (_, __) => const ResetPasswordPage()),
